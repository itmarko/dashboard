...
const Sidebar = ({ children }) => {
  ...
  return (
    <>
      ...
      >
        <nav
          className={`flex flex-col bg-gray-800 dark:bg-gray-50 dark:text-gray-600 dark:border-gray-600 border-r shadow-sm transition-all duration-300 ease-in-out ${
            expanded ? "w-48" : "w-16"
          }`}
        >
          <div className="p-4 pb-2 flex items-center relative">
            ...
            />
            <button className="p-1 ml-2 rounded-full bg-gray-50 hover:bg-gray-100 text-gray-800 absolute -right-3 border border-gray-800 top-5">
        ...
        <li
          ...
          className={`relative flex items-center py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors group ${
            active
              ...
              : "hover:bg-gray-600 text-gray-300 dark:text-gray-700 dark:hover:bg-gray-300"
          }`}
        >
          <span className="text-xl">{icon}</span>
          <span
            className={`overflow-hidden transition-all text-white text-sm ml-3 dark:text-gray-700 ${
