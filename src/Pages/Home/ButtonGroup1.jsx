...
const ButtonGroup = () => {
  ...
  return (
    <>
      <div className="relative flex flex-col items-center justify-center bg-gradient-to-b from-[#1A1A2E] to-[#2C2B55] text-white">
      ...
      <div className="w-full bg-[#1C1C2E] py-6 shadow-lg mt-0"> {/* Remove margin-top here */}
        {/* Centered Content Area */}
        <div className="max-w-2xl mx-auto space-y-6 px-4">
          {/* Button Group */}
          <div className="flex flex-wrap justify-center space-x-4 bg-transparent border border-gray-600 rounded-full px-4 py-2 mt-0">
            {buttons.map((button) => (
              <button
                key={button}
